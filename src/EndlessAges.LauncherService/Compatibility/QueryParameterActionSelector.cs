...
{
	//Based on Microsoft's: https://github.com/aspnet/Mvc/blob/master/src/Microsoft.AspNetCore.Mvc.Core/Internal/ActionSelector.cs
	/// <summary>
	/// A query string parameter name based action selector <see cref="IActionSelector"/> implementation.
	/// </summary>
	public class QueryParameterActionSelector : IActionSelector
	{
		...
		public QueryParameterActionSelector(
		...
		public ActionDescriptor SelectBestCandidate(RouteContext context, IReadOnlyList<ActionDescriptor> candidates)
		{
			...
			else
			{
				...
				if (!parameterFilteredDescriptors.Any() || parameterFilteredDescriptors.Count() > 1)
				{
					...
					throw new AmbiguousActionException(actionNames);
				}
